...
export default function Notifications() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <header className={`bg-white/95 backdrop-blur-md sticky top-0 z-40 shadow-md border-b border-indigo-100 h-20 transition-all duration-300  'translate-y-0' ${sidebarOpen ? 'hidden md:block' : 'block'}`}>
